...
---
# Build your first full-stack ink! dApp
...
With the ink!athon Boilerplate, we abstracted away a lot of complexity on the frontend- and contract-levels to give developers a starting point to setup their first ink! project with a working pre-configured but un-opinionated workspace. 
